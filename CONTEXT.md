...
**GitHub Shopfront**:
The primary public surface: a single GitHub repo under the user's actual name (Owen) that mirrors the monorepo's content and serves as the portfolio shopfront with a Hallmark README. This is NOT one-repo-per-skill — the default public structure is one repo.
